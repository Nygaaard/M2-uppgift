...
const todoObject = new (0, _todo.ToDoList)(initialTodoList ? JSON.parse(initialTodoList || "") : []);
function displayTodos() {
    ...
    todoList.forEach((todo, index)=>{
        ...
        const divForPriority = document.createElement("div");
        ...
        if (todo.priority === 1) {
            priorityParagraph.textContent = "Prioritet: H\xf6g";
            divElement.classList.add("high");
        } else if (todo.priority === 2) {
            priorityParagraph.textContent = "Prioritet: Medium";
            divElement.classList.add("medium");
        } else if (todo.priority === 3) {
            priorityParagraph.textContent = "Prioritet: L\xe5g";
            divElement.classList.add("low");
        } else {
            errorEl.textContent = "Du m\xe5ste v\xe4lja en prioritet!";
            return;
        }
        if (todo.completed) divElement.classList.add("completed");
...
},{"./todo":"3Vq5A"}],"3Vq5A":[function(require,module,exports) {
...
},{}]},["3L0Bc","hYrgI"], "hYrgI", "parcelRequire61bd")
